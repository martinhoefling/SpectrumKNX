...
import { ShieldCheck, LayoutDashboard, History, Settings, Play, Pause, Download, Trash2, SlidersHorizontal, LineChart, ChevronDown } from 'lucide-react';
...
function App() {
  ...
  const [rateMode, setRateMode] = useState<'s' | 'm' | 'h'>((getCookie('rateMode') as any) || 's');
